        ...
        <InfoContainer>
          ...
          <FilterContainer>
            <Filter>
              ...
              {product.color && product.color.map(c => (<FilterColor onClick={()=>{setColor(c)}} color={c} key={c} />))}
            </Filter>
            <Filter>
          ...
          <AddContainer>
            <AmountContainer>
              <Remove style={{cursor: 'pointer'}} onClick={()=>{amount > 1 && setAmount(amount - 1)}}/>
              <Amount>{amount}</Amount>
              <Add style={{cursor: 'pointer'}} onClick={()=>{setAmount(amount + 1)}}/>
            </AmountContainer>
            <Button onClick={handleAddToCartBtnClick}>ADD TO CART</Button>
          </AddContainer>
        </InfoContainer>
      </Wrapper>
      <Newsletter />
